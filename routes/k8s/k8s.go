...
import (
	"devops-console-backend/routes/k8s/cluster"
	"devops-console-backend/routes/k8s/cronjob"
	"devops-console-backend/routes/k8s/daemonset"
	"devops-console-backend/routes/k8s/deployment"
	"devops-console-backend/routes/k8s/job"
	"devops-console-backend/routes/k8s/namespace"
	"devops-console-backend/routes/k8s/node"
	"devops-console-backend/routes/k8s/pod"
	"devops-console-backend/routes/k8s/service"
